        ...
        <form   >
            <div className="form-group">
                <div className="input-group mb-3">
                    ...
                    <div className="input-group-append" style={{ backgroundColor: "#624bff", borderTopRightRadius: "10px", borderBottomRightRadius: "10px" }}>
                        <button onClick={() => handleSearchProduct()} className="btn" type="button"><i className="ti-search" style={{ color: "white" }} /></button>
                    </div>
                </div>
            </div>
