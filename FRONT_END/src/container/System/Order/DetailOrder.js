        ...
        <>
            <div className="wrap-order">
                ...
                <div className="wrap-order-item">
                    <section className="cart_area">
                        <div className="container">
                            ...
                            <div className="box-shopcart-bottom ">
                                <div className="content-left flex justify-content-between container">
                    ...
                    <div className="wrap-payment" style={{ display: "flex", flexDirection: "column", gap: "20px", margin: "50px 30px 0px 30px" }}>
                        <div
                        ...
                        <div className="content-bottom">
                            {DataOrder && DataOrder.addressUser && (
                                <div className="wrap-bottom">
                                    ...
                                    <div className="box-flex">
                                        <div className="head" style={{ width: "145px  " }}>Địa chỉ nhận hàng </div>
                                        <div>{DataOrder.addressUser.shipAdress}</div>
                                    </div>
                                </div>
                            )}
