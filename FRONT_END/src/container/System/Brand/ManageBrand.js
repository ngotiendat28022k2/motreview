...
const ManageBrand = () => {
    ...
    let handleDeleteBrand = async (event, id) => {
        ...
        const isConfirmed = window.confirm("Bạn có chắc chắn muốn xóa nhãn hàng này không?");
        if (isConfirmed) {
        ...
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                <div className="card-header flex justify-content-between">
                    <Link to={'/admin/add-brand'} className="btn btn-primary d-flex align-items-center" ><i className="bi bi-plus fs-5 me-2"></i> Thêm nhãn hàng</Link>
                    <div className='col-8'>
